...
import com.gpt.akiradart.persistence.dao.UserLocationRepository;
import com.gpt.akiradart.persistence.dao.UserRepository;
import com.gpt.akiradart.persistence.dao.token.NewLocationTokenRepository;
...
import com.gpt.akiradart.web.error.UserAlreadyExistException;
...
public class UserService implements IUserService {
  ...
  @Override
  public User registerNewUserAccount(final RegistrationUserDTO accountDto) {
  ...
  public String generateQRUrl(User user) throws UnsupportedEncodingException {
    return QR_PREFIX + URLEncoder.encode(
        String.format("otpauth://totp/%s:%s?secret=%s&issuer=%s", APP_NAME, user.getEmail(),
            user.getSecret(), APP_NAME),
